...
if is_package_installed('django_redis') and os.environ.get('USE_REDIS', 'False') == 'True':
    CACHES = {
        'default': {
...
if is_package_installed('channels_redis') and os.environ.get('USE_REDIS', 'False') == 'True':
    CHANNEL_LAYERS = {
        'default': {
