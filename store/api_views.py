...
class VendorAnalyticsAPIView(APIView):
    ...
    def get(self, request):
        ...
        # Calculate metrics using optimized DB aggregation
        ...
        total_revenue = float(revenue_metrics['total'] or 0)
        monthly_revenue = float(revenue_metrics['monthly'] or 0)
        weekly_revenue = float(revenue_metrics['weekly'] or 0)
