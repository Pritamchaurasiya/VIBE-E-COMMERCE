...
class VendorAnalyticsAPIView(APIView):
    ...
    def get(self, request):
        ...
        # Used for revenue calculation and order counting
        order_items_qs = OrderItem.objects.filter(
            vendor=vendor,
            order__paid=True
        )

        # Calculate metrics efficiently using database aggregation
        # This avoids fetching all OrderItem objects into memory
