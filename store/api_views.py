...
class ProductListView(generics.ListAPIView):
    ...
    def get_serializer_context(self):
        """Add wishlist items to context to avoid N+1 queries."""
    ...
    def get_queryset(self):
        # Optimization: Add prefetch_related for images and annotate ratings/reviews
        # to prevent N+1 queries in the serializer
