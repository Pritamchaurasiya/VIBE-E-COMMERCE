...
class VendorAnalyticsAPIView(APIView):
    ...
    def get(self, request):
        ...
        # Bolt Optimization: Replaced Python-based iteration with database aggregation
        # to avoid O(N) memory usage and iteration over order items.
        # This significantly improves performance for vendors with many orders.
