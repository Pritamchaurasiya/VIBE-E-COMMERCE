...
class ProductListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        # Optimization: select_related for FKs, prefetch_related for M2M/Reverse FKs
        queryset = Product.objects.select_related('category', 'vendor').prefetch_related('images').filter(is_active=True)

        # Annotate with rating and review count to avoid N+1 queries
    ...
    def list(self, request, *args, **kwargs):
        ...
        # Optimization: Fetch wishlist IDs once for the current user
