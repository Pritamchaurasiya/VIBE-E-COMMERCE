...
class DashboardStatsView(APIView):
    ...
    def get(self, _request):
        ...
        # Optimized: Combine queries into single aggregation
        ...
        # Order counts
        # Optimized: Combine queries into single aggregation
        orders_aggregates = all_orders.aggregate(
            total=Count('id'),
        ...
        orders_stats = orders_aggregates
        ...
        products_stats = products_aggregates

        # Users statistics (User already imported at top)
        # Optimized: Combine queries into single aggregation
        users_aggregates = User.objects.aggregate(
            total=Count('id'),
