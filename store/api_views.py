...
class ProductListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        queryset = queryset.prefetch_related('images', 'reviews', 'wishlisted_by')
        # Annotate with review metrics to avoid N+1 queries
    ...
    def list(self, request, *args, **kwargs):
        ...
        # Optimize wishlist check by fetching all wishlist product IDs for the user once
        ...
        # Inject wishlist IDs into serializer context
        serializer_context = self.get_serializer_context()
        serializer_context['user_wishlist_ids'] = user_wishlist_ids
...
class RegisterView(APIView):
    ...
    def post(self, request):
        ...
        # Use get_or_create to handle potential signal-created objects
