"""
Tracking models for the store app.
"""
...
class DataModificationTracker(models.Model):
    ...
    def __str__(self):
        return f"{self.operation} {self.table_name} #{self.object_id}"
...
class TrackingDataRetention(models.Model):
    ...
    def __str__(self):
        return f"Retention: {self.get_data_type_display()} ({self.retention_period} {self.retention_unit})"
