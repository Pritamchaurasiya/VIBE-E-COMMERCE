...
This module contains models for the enhanced tracking system.
"""
...
class SystemAccessTracker(models.Model):
    ...
    def __str__(self):
        return f"{self.access_type} - {self.risk_level}"
...
class TrackingDataRetention(models.Model):
    ...
    retention_unit = models.CharField(max_length=20, choices=RETENTION_UNITS, default='days')
