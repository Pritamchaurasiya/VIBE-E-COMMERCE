...
class ProductSerializer(serializers.ModelSerializer):
    ...
    def get_is_in_wishlist(self, obj):
        ...
        # Use pre-fetched wishlist IDs if available (optimization)
        user_wishlist_ids = self.context.get('user_wishlist_ids')
        if user_wishlist_ids is not None:
            return obj.id in user_wishlist_ids
    ...
    def get_average_rating(self, obj):
        ...
        # Use annotated value if available (optimization)
